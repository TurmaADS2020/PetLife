...
|Nº|Nome|Descrição|Local| Status dev |
|--|----|---------|-----|------------|
...
|UC008|Adota Animal|Processo de adotar um animal cadastrado na plataforma|<a href="https://github.com/TurmaADS2020/PetLife/blob/main/documentation/requirements/use_cases/1.2.3_Pagina_apos_logado.md"> Link </a>|Ok |
