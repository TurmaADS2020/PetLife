# AVISO LEGAL -Políticas de Privacidade
...
<table>
	...
	<tr valign="top">
		...
		<td><p>
			...
			efetuar cobranças.</p>
			<p>III. Cumprir com as obrigações legais de manutenção de
			registros</p>
			<p>estabelecidas pelo Marco Civil da Internet - Lei 12.965/2014 e
			LGPD.</p>
			<p>IV.Obter informações acerca do que é produzido pelo usuário
			ou</p>
			<p>assuntos pessoais de seu interesse, para um melhor
			gerenciamento de</p>
			<p>sua conta dentro da aplicação. Assertividade e segurança no
			acesso:</p>
			<p>manter suas informações cadastrais corretas e atualizadas,
			permitindo a</p>
			<p>verificação e confirmação da sua identidade, a prevenção
			de fraude,</p>
			<p>bem como evitar o contato de contatos indevidos.</p>
			<p>V. Relacionamento do cliente com o Usuário. X. Envio de
			Newsletter.</p>
			<p>VI. Envio de Newsletter.</p>
		</td>
	</tr>
	<tr></tr>
	<tr></tr>
